export const Header = ({ setModal, modal }) => {
  return (
    <div>
      <div className="hidden lg:block fixed  z-[2] top-[2%] left-[5%] font-black text-white text-3xl animate-pulse duration-1000 ">
        FESMIVA STORE.
      </div>
      <div className="w-full fixed z-[4]">
        <div className="">
          <div className="flex justify-center items-center my-4">
            <div className="text-white bg-[#2F3237] flex rounded-full p-2 2xl:w-[30%] 2xl:hover:w-1/3 items-center opacity-40 hover:opacity-100 duration-700">
